...
import com.parox.fastdfs.ClientGlobal;
import com.parox.fastdfs.DownloadCallback;
import com.parox.fastdfs.FileInfo;
import com.parox.fastdfs.ProtoCommon;
import com.parox.fastdfs.StorageServer;
import com.parox.fastdfs.TrackerClient;
import com.parox.fastdfs.TrackerServer;
import com.parox.fastdfs.UploadCallback;
import com.parox.fastdfs.UploadStream;
import com.parox.fastdfs.common.Base64;
import com.parox.fastdfs.common.MyException;
import com.parox.fastdfs.common.NameValuePair;

/**
 * 组名和文件名两个字段分开的方式（by Zhangguanjun）
