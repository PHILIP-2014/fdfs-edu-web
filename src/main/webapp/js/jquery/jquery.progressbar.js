	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: _contextPath+'/images/jq/progressbar/progressbar_14.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	_contextPath+'/images/jq/progressbar/progressbg_red.gif',
									30: _contextPath+'/images/jq/progressbar/progressbg_orange.gif',
									70: _contextPath+'/images/jq/progressbar/progressbg_green.gif'
								},
